<%-- 
    Document   : phukien
    Created on : Nov 4, 2021, 8:23:19 AM
    Author     : bin31122000
--%>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="phukien.jsp" id="highlight"> <span class="pull-right"></span>PHỤ KIỆN</a>
                                    </li>
                                    <li>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="${imagehomeURL}/product9.png" alt="" />
                                        <h2>7,260,000 <span class="vnd"><sub>VNĐ</sub></span></h2>
                                        <p>ROLAND RH-300</p>
