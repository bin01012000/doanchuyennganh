<%-- 
    Document   : vocals
    Created on : Nov 4, 2021, 8:24:11 AM
    Author     : bin31122000
--%>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="vocals.jsp" id="highlight"> <span class="pull-right"></span>VOCALS</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="${imagehomeURL}/product12.png" alt="" />
                                        <h2>10,000,000 <span class="vnd"><sub>VNĐ</sub></span></h2>
                                        <p>ROLAND VT-3</p>
