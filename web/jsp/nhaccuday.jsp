<%-- 
    Document   : nhaccuday
    Created on : Nov 4, 2021, 8:22:49 AM
    Author     : bin31122000
--%>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="nhaccuday.jsp" id="highlight"> <span class="pull-right"></span>NHẠC CỤ DÂY</a>
                                    </li>
                                    <li>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="${imagehomeURL}/product7.png" alt="" />
                                        <h2>8,060,000 <span class="vnd"><sub>VNĐ</sub></span></h2>
                                        <p>SCHERL & ROTH SR41E4H</p>
