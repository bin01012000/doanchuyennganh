<%-- 
    Document   : nhaccuhoi
    Created on : Nov 4, 2021, 8:22:55 AM
    Author     : bin31122000
--%>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="nhaccuhoi.jsp" id="highlight"> <span class="pull-right"></span>NHẠC CỤ HƠI</a>
                                    </li>
                                    <li>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="${imagehomeURL}/product8.png" alt="" />
                                        <h2>150,000 <span class="vnd"><sub>VNĐ</sub></span></h2>
                                        <p>N310RDBK</p>
